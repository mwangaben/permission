...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			modelhaspermission.Table: modelhaspermission.ValidColumn,
			modelhasrole.Table:       modelhasrole.ValidColumn,
			permission.Table:         permission.ValidColumn,
			role.Table:               role.ValidColumn,
			rolehaspermission.Table:  rolehaspermission.ValidColumn,
