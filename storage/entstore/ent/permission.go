...
type Permission struct {
	...
	// GuardName holds the value of the "guard_name" field.
...
func (*Permission) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case permission.FieldName, permission.FieldGuardName, permission.FieldTenantID:
...
func (_m *Permission) String() string {
	...
	builder.WriteString(_m.GuardName)
	builder.WriteString(", ")
